...
\newcommand{\fitif}[4]{
  \begin{array}{ll}
    \multicolumn{2}{l}{\mathsf{if}\ #1} \\
    \multicolumn{2}{l}{\mathsf{return}\ #2} \\
    \mathsf{then} & #3 \\
    \mathsf{else} & #4
  \end{array}
}
...
\newcommand{\fitbranch}[2]{\mid #1 &\Rightarrow& #2}
\newcommand{\pmatch}[3]{
  \begin{array}{lcl}
...
\newcommand{\fitmatch}[3]{
  \setlength\arraycolsep{2pt}
  \begin{array}{lcl}
    \multicolumn{3}{l}{\mathsf{match}\ #1} \\
    \multicolumn{3}{l}{\mathsf{return}\ #2} \\
    \multicolumn{3}{l}{\mathsf{with}} \\
    #3 \\
    \multicolumn{3}{l}{\mathsf{end}} \\
  \end{array}
}
...
\newcommand{\Iz}{\mathbb{0}}
\newcommand{\Io}{\mathbb{1}}
