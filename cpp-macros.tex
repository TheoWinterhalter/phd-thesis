...
\newcommand{\aapp}[4]{#1\mathbin{@_{#2.#3}} #4}                  % application
...
\newcommand{\funexts}[5]
  {\st{\mathsf{funext}}(#1,#2,#3,#4,#5)}                        % strict funext
\newcommand{\funext}[5]
...
\newcommand{\transitivity}[2]{\mathsf{transitivity}(#1,#2)}
