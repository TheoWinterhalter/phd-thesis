...
\tikzset{sim/.style={decorate, decoration={coil, aspect = 0, post length = 0mm, pre length = 0mm, segment length = 0.9cm, pre = moveto, post = moveto}}}
...
\input{chapters/coq-completeness.tex}
\input{chapters/coq-conclusion.tex}
