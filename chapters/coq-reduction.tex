  ...
  \infer
    {
      ...
      \vscmd
        {u_n}
        {
          \stack{(\fixp_n (f : \Pi \Delta. T).\ t)\ u_1\ \dots\ u_{n-1}\ \shole}
          :: \pi
        }
      \red_\WM
      \vscmd
      ...
      \Ga \vdash
      \vscmd
        {t[f \sto \fixp_n (f : \Pi \Delta. T).\ t]}
        {
          \coapp{u_1} :: \dots :: \coapp{u_{n-1}} ::
          \coapp{\mathsf{C}\ v_1\ \dots v_m} :: \pi
        }
      \red_\WM
      a
    }
