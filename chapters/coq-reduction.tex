...
\todo{whne/whnf should be updated for fix}
...
\begin{mathpar}
  \infer
    {\dpair{t \mid u :: \pi} \red_\WM a}
    {\dpair{t\ u \mid \pi} \red_\WM a}
  %

  \infer
    {\dpair{t[x \sto u] \mid \pi} \red_\WM a}
    {\dpair{\lambda (x:A).t \mid u :: \pi} \red_\WM a}
  %
\end{mathpar}
\todo{Improve, fix, complete?}
