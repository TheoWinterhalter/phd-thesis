...
\begin{table*}
  ...
  \begin{tabular}{l|c|c|c|c|}
    ...
    P & U & U & U \\
    \hline
    \multicolumn{1}{ |c|  }{Confluence} &
    yes & yes & N/A & N/A \\
    \hline
    \multicolumn{1}{ |c|  }{Normalisation} &
    yes & yes & N/A & N/A \\
    \hline
    \multicolumn{1}{ |c|  }{Subjcet reduction} &
    yes & yes & N/A & N/A \\
    \hline
    \multicolumn{1}{ |c|  }{Injectivity of \(\Pi\)-types} &
    yes & yes & no & no \\
    \hline
    \multicolumn{1}{ |c|  }{Computational (comp) or regular (reg) canonicity} &
    comp & comp & reg & no \\
    \hline
    \multicolumn{1}{ |c|  }{Decidability of type checking} &
    yes & yes & no & yes \\
    \hline
