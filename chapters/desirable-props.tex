...
I will write -- for properties that don't apply like properties on reduction
for a theory without.
...
\begin{table*}
  ...
  \begin{tabular}{l|c|c|c|c|}
    ...
    yes & yes & -- & -- \\
    \hline
    \multicolumn{1}{ |l|  }{Subjcet reduction} &
    yes & yes & -- & -- \\
    \hline
    \multicolumn{1}{ |l|  }{Injectivity of \(\Pi\)-types} &
    yes & yes & no & no \\
    \hline
    \multicolumn{1}{ |l|  }{Computational (comp) or regular (reg) canonicity} &
    comp & comp & reg & no \\
    \hline
