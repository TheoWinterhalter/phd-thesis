...
\todo{Add constructiveness (wrt computation as well), as well as other ways
of doing formal proofs and other proof assistants. It means I probably need to
talk about classical logic (and callc). Also HoTT.}
