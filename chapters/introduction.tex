...
\marginnote[1.3cm]{
  The picture can be misleading, I am really talking about a concrete objects
  that people can run through their own proof assistant to check that your proof
  is indeed valid.
}
\begin{center}
