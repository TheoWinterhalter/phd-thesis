...
This ``proof'' makes a lot of assumptions so it I cannot conclude in a more
general setting. For instance strengthening is a strong property to have,
it doesn't hold in \acrshort{ETT} but it does in \acrshort{ITT} and
\acrshort{WTT}, as such I believe my assumptions aren't that restrictive.
One of the reasons such a translation isn't possible is that it would translate
...
between the two types. \([u] =_{[A]} [v]\) doesn't necessarily make sense
anymore.
