...
In proof theory, this property is called \emph{cut-elimination}, as the
\emph{modus ponens} rules is called a \emph{cut}, in that it removes all
superfluous applications of \emph{cut} in the proof.
