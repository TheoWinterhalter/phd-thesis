...
\(\Pi\ A\ B : \CTy\ \Ga\) as
\[
  (\Pi\ A\ B)(\gamma) = \card{\prod_{x \in A(\gamma)} B(\beta(\gamma,x))}
\]
...
\[
  \begin{array}{lcl}
    (\lambda b)(\gamma) &=& \beta(x \mapsto b(\beta(\gamma,x))) \\
    \capp(f,u)(\gamma) &=& \beta^{-1}(f(\gamma))(u(\gamma))
  \end{array}
\]
Now we show
\[
...
% \[
%   \begin{array}{lc>{\displaystyle}lcl}
...
%     &=& \card{
%       \prod_{x \in A(\sigma(\gamma))}
%       B(\beta((\sigma \circ \pp)(\beta(\gamma, x)), \pq(\beta(\gamma, x))))
%     } \\
%     &=& \card{
%       \prod_{x \in A(\sigma(\gamma))}
%       B(\beta((\sigma(\pp(\beta(\gamma, x)))), \pq(\beta(\gamma, x))))
%     } \\
%     &=& \card{
%       \prod_{x \in A(\sigma(\gamma))}
%       B(\beta((\sigma(\pp(\beta(\gamma, x)))),
%       \pi_2(\beta^{-1}(\beta(\gamma, x)))))
%     } \\
%     &=& \card{
%       \prod_{x \in A(\sigma(\gamma))}
%       B(\beta((\sigma(\pp(\beta(\gamma, x)))), \pi_2(\gamma, x)))
%     } \\
%     &=& \card{
%       \prod_{x \in A(\sigma(\gamma))}
%       B(\beta((\sigma(\pp(\beta(\gamma, x)))), x))
%     }
%   \end{array}
% \]
