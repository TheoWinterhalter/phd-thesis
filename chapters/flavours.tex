...
\acrshort{ETT} and \acrshort{ITT} in \arefpart{elim-reflection}.
...
\marginnote[0.2cm]{
  \acrshort{UIP} is given computational content in \Agda, it's feasible so
  it's not really an argument against this definition.
}
...
and better fit the Setoïd model~\sidecite[0.3cm]{altenkirch1999extensional}.

\subsection{\acrfull{HoTT}}

\paradot{Univalence}

\paradot{\acrfull{CubicalTT}}

\paradot{\acrfullpl{2TT}}

\acrshort{HTS}~\sidecite{hts-sota}
