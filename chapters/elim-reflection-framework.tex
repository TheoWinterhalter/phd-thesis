...
\[
  \begin{array}{l@{~\,}r@{~\,}l}
    ...
    \bnfor \lamb{B_1}{B_2}{t_1}{t_2}{p_A}{p_B}{p_t} \\
    &\bnfor& \appb{B_1}{B_2}{p_u}{p_A}{p_B}{p_v}
    \bnfor \pib{B_1}{B_2}{p_A}{p_B} \\
    &\bnfor& ...
  \end{array}
\]
\todo{Not clear what to put, maybe just the needed principles to go under
binders, but that's a lot because of annotations.}
