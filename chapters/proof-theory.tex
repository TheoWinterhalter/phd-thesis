...
This logic is \emph{constructive} in that, from every proof derivation one can
...
in the derivation above \(\vdash P \to P \wedge P\) by the derivation of
\(\vdash P\) on the right.
\[
  \infer*[Right=\((\wedge I)\)]
    {
      \infer*[Right=\((\neg I)\)]
